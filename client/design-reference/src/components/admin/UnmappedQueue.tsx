...
import type { UnmappedSku } from '../../types/recon';
...
export function UnmappedQueue({ items, onAccept, onDismiss }: UnmappedQueueProps) {
  return (
    <section
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="ml-2 text-2xs text-neutral-600">
          Fuzzy matches from today&apos;s LeverEdge export. Accepting creates a permanent mapping.
        </p>
      </div>
        ...
        <li
          ...
          className="flex items-center gap-4 rounded-md border border-neutral-200 bg-white px-3 py-2.5">
              ...
              <div className="ml-auto flex items-center gap-3">
                ...
                <Button variant="accent" size="sm" onClick={() => onAccept(item.id)}>
                  Accept
                </Button>
                <button
              type="button"
              ...
              className="rounded p-1.5 text-neutral-400 transition-colors duration-150 ease-out hover:bg-neutral-100 hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand">
